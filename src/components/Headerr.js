...
export const Headerr = () => {
 ...
 // const [darkMode, setDarkMode] = useState( JSON.parse(localStorage.getItem("darkMode")) || false);
  ...
  const activeClass = "block py-2 px-3 text-white bg-blue-700 rounded-full border-8 border-y-4  md:text-blue-700 md:p-0 dark:text-blue-500 bg-slate-200";
  const inactiveClass = "block text-base py-2 px-3 text-gray-900 rounded-full bg-gray-200  border-8 border-y-4  md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-black dark:hover:text-white md:dark:hover:bg-transparent dark:border-black dark:bg-black";
...
const [darkMode, setDarkMode] = useState(JSON.parse(localStorage.getItem("darkMode")) || false);
  ...
  return (
    <header className="bg-transparent">
      <nav className="bg-slate-200  dark:bg-black px-2 sm:px-4 py-0">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-3">
          ...
          <button onClick={() => setDarkMode(!darkMode)} data-tooltip-target="navbar-search-example-toggle-dark-mode-tooltip" type="button" data-toggle-dark="light" className="flex items-center p-2 mr-2 text-xs font-medium text-gray-700 bg-white rounded-lg border-2 border-gray-200 toggle-dark-state-example hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-500 dark:bg-gray-800 focus:outline-none dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
          ...
          <div id="nav-links, navbar-search" className={`${hidden?"hidden":"empty"} items-center justify-between  w-full md:flex md:w-auto md:order-1`} >
            ...
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-bold border border-gray-100 rounded-lg bg-slate-200 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-slate-200 dark:bg-black md:dark:bg-black dark:border-gray-700">
              <li >
