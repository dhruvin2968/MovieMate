...
export const Headerr = () => {
 ...
 // const [darkMode, setDarkMode] = useState( JSON.parse(localStorage.getItem("darkMode")) || false);
  ...
  const activeClass = "block py-2 px-3 text-blue-700 bg-blue-700 rounded-full md:text-blue-700 md:p-0 dark:text-blue-500 dark:bg-black bg-slate-200";
  const inactiveClass = "block text-base py-2 px-3 text-gray-900  bg-slate-200  md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-black dark:hover:text-white md:dark:hover:bg-transparent dark:border-black dark:bg-black";
  ...
  const handleSubmit = (event) => {
    ...
    if (queryTerm.trim()) { // Check if the input is not empty
    ...
    <header className="bg-transparent">
      <nav className="bg-slate-200  dark:bg-black pl-2 sm:px-4 py-0">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-3">
          ...
          <button onClick={() => setDarkMode(!darkMode)} data-tooltip-target="navbar-search-example-toggle-dark-mode-tooltip" type="button" data-toggle-dark="light" className="flex items-center p-2 mr-2 text-lg font-medium text-gray-700 bg-white md:dark:bg-gray-700 dark:bg-black rounded-lg border-1 border-gray-700 toggle-dark-state-example hover:bg-gray-100 hover:text-blue-700  focus:ring-2 focus:ring-gray-300  focus:outline-none dark:text-gray-400  dark:hover:text-white dark:hover:bg-gray-700">
            ...
            <button onClick={()=>setHidden(!hidden)} type="button" data-collapse-toggle="navbar-search" aria-controls="navbar-search" aria-expanded="false" className="md:hidden text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none   rounded-lg text-sm p-2.5 me-1">
            ...
            <button onClick={()=>setHidden(!hidden)}   data-collapse-toggle="navbar-search" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-search" aria-expanded="false">
          ...
          <div id="nav-links, navbar-search" className={`${hidden?"hidden":"empty"} items-center justify-between  w-full md:flex md:w-auto md:order-1`} >
            <div className="relative mt-3 md:hidden">
              ...
              <div onChange={handleSubmit}>
              <input name="search" type="text" id="search-navbar" className="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-slate-200 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." autoComplete="off"/>
            </div>
